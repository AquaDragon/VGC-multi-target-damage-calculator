...
function populateTable(parsedDataTeamA, parsedDataTeamB) {
    ...
    for (let row = 1; row <= parsedDataTeamA.length; row++) {
        for (let col = 1; col <= parsedDataTeamB.length; col++) {
            ...
            var resultA = [], resultB = [], minDamageA, minDamageB, maxDamageA = [], maxDamageB = [], minPercent, maxPercent, percentText;
            ...
            for (var i = 0; i < 4; i++) {
                ...
                resultA[i].damageText = p1.moves[i].name + ' ' + minDamageA + "-" + maxDamageA[i] + " (" + minPercent + " - " + maxPercent + "%)";
                ...
                resultB[i].damageText = p2.moves[i].name + ' ' + minDamageB + "-" + maxDamageB[i] + " (" + minPercent + " - " + maxPercent + "%)";
            }
